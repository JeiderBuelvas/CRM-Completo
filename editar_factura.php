<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura, facturas.nota, facturas.tiempo_entrega";
...
<html lang="en">
  ...
  <body>
    ...
    <h4>
        ...
        Editar Cotización N° <?php echo $numero_factura; ?>
    </h4>
    </div>
				...
				<div class="form-group row">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="condiciones" name="condiciones">
									<option value="1" <?php if ($condiciones==1){echo "selected";}?>>100% anticipo contra proforma</option>
									<option value="2" <?php if ($condiciones==2){echo "selected";}?>>A Convenir.</option>
									<option value="3" <?php if ($condiciones==3){echo "selected";}?>>30 Dias Fecha Facturada</option>
									<option value="4" <?php if ($condiciones==4){echo "selected";}?>>50% anticipo - 50% crédito</option>
									<option value="5" <?php if ($condiciones==5){echo "selected";}?>>50% anticipo - 50% pago contado</option>
								</select>
                            ...
                            <option value="2" <?php if ($estado_factura == 2) { echo "selected"; } ?>>Procesada</option>
                            <option value="3" <?php if ($estado_factura == 3) { echo "selected"; } ?>>Cancelada</option>
                            </select>
                           </div>
                        ...
                        <div class="col-md-3">
                        <textarea name="nota" rows="5" class="form-control input-sm" placeholder="Escribe tu observación..."><?php echo $nota;?></textarea>
                        </div>
				<!------------------------------------------------------>
				<!------------ CAMPO MODIFICADO ------->
				        <label for="tiempo_entrega" class="col-md-1 control-label">Tiempo </label>
                        <div class="col-md-7">
                        <textarea name="tiempo_entrega" rows="2" class="form-control input-sm" placeholder="Tiempo de Entrega..."><?php echo $tiempo_entrega;?></textarea>
                        </div>
				<!------------------------------------------------------>
				<div class="col-md-12">
