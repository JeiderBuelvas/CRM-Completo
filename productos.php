	...
	<div class="panel panel-info">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Nuevo Servicio</button>
			</div>
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var kilogramos = $("#kilogramos"+id).val();
			var estado = $("#estado"+id).val();
			var precio_producto = $("#precio_producto"+id).val();
			$("#mod_id").val(id);
			$("#mod_codigo").val(codigo_producto);
			$("#mod_nombre").val(nombre_producto);
			$("#mod_kilogramos").val(kilogramos);
